(function (global, factory) {
    ...
    $.extend(window.vcan.common,
        {
            ...
            getQueryStringByName2: function (url, name) {
                console.log('1111')
    ...
    $.extend(window.vcan.service, {
        ...
        fileUrl: {
            ...
            TEST: "https://filesvc.yqytest.com/api/gateway",
            PRODUCTION: "https://filesvc.yqybl.com/api/gateway"
        },
        ...
        callFile: function (options) {
            ...
            $.ajax({
                type: options.type,
                traditional: options.traditional,
                url: window.$v.service.getFileUrl() + "/" + options.action,
                dataType: options.dataType,
